                ...
                <div className="hidden w-full xl:block sm:block md:block">
                    <div className="max-w-xl text-center">
                        ...
                        <div className="mt-7.5 text-center">
                            <h2 className="mb-3 text-2xl font-bold text-black dark:text-white">{t('The unexpected has occurred!')}</h2>
                            <Link className="mt-7.5 inline-flex items-center gap-2 rounded-md bg-primary py-3 px-6 font-medium text-white hover:bg-opacity-90" to={u('/dashboard')}>
